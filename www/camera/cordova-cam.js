...
function onPhotoDataSuccess(imageData) {
  ...
  if(imageID == '#IMAGE'){
    ...
    $.ajax({
        type: "POST",
        url: 'http://web.farroupilha.ifrs.edu.br/paginas/~vinicius.meng/Projetos/Schoolendar/atlFotoTurma.php',
        data: ({
        ...
        success: function(result, jqXHR) {
		  ...
		  carregaUsers();
          navigator.notification.alert("Foto da turma atualizada com sucesso!", null, "", "Ok");		  
        },
        error: function(response) {
          navigator.notification.alert("Erro ao atualizar a foto da turma!", null, "", "Ok");
        }
      });
  }  
