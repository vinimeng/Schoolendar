...
app.initEvents = function() {
	...
	window.FirebasePlugin.getToken(function(token1) {
	...
	window.FirebasePlugin.onNotificationOpen(function(notification) {
        navigator.notification.alert(""+notification.body+"", null, ""+notification.title+"", "Ok");
...
//ENABLE CORS
	function cors(){
		$.ajax({
           type: "POST",
           url: 'http://web.farroupilha.ifrs.edu.br/paginas/~vinicius.meng/Projetos/Schoolendar/index.php',
           data: ({msg: "go"}),
    	   dataType: "json",
    	   success: function(result, jqXHR) {
				$("#servidores").html(""+result["msg"]+"");
           }
        });
	}
